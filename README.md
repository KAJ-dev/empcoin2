![image](https://cdn.discordapp.com/attachments/604564664692768768/604564700889612299/5d37c5316da7c-480x480.png)
...
- `export CC=gcc-8`
- `export CXX=g++-8`
- `git clone -b development --single-branch https://github.com/turtlecoin/turtlecoin`
- `cd turtlecoin`
- `mkdir build`
- `cd build`
- `cmake ..`
